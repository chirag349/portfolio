...
export default function About() {
  ...
  return (
    ...
    >
      {/* Background Orbs */}
      <motion.div
        className="absolute top-16 left-10 w-64 h-64 bg-[#d9a85c] opacity-20 blur-3xl rounded-full pointer-events-none"
        animate={{ scale: [1, 1.25, 1], rotate: [0, 45, 0] }}
        transition={{ duration: 12, repeat: Infinity }}
      />
      <motion.div
        className="absolute bottom-24 right-16 w-80 h-80 bg-[#1a2b4b] opacity-30 blur-3xl rounded-full pointer-events-none"
      ...
      <div className="relative z-20 flex flex-col items-center w-full max-w-5xl">
        ...
        <motion.div
          ...
          className="flex flex-wrap justify-center gap-6 mb-12 z-30"
        >
